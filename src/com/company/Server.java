...
//    private final static String HEADERS = "HTTP/1.1 200 JR\n"
//            + "Server: server\n"
...
//            + "Connection: close\n\n";
    ...
    public void bootstrap() {
        try {
            ...
            server.bind(new InetSocketAddress("127.0.0.1", 5555));
            while (true) {
    ...
    private void handleClient(Future<AsynchronousSocketChannel> future)
        ...
        while (clientChannel != null && clientChannel.isOpen()) {
            ...
            else
            {
                ...
                response.addHeader("Content-Type", "text/html; charset-utf-8");
                response.setBody("<html><body><h1> Resourse not found </h1></body><html>");
            }
